...
STATIC BitmapFontMap	BitmapFont::s_bitmapFontRegistry;
...
{
	m_glyphSheets = other.m_glyphSheets;
...
//---------------------------------------------------------------------------
STATIC void BitmapFont::FreeBitmapFontRegistryMemory()
{
	DestroyMap( s_bitmapFontRegistry );
}
