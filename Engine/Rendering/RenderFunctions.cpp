...
//---------------------------------------------------------------------------
void RenderTexturedQuadWithVertexArrayAndShader( unsigned int shaderProgramID, VennEnum mode )
{
	Vertex3D vertexes[ 4 ];

	vertexes[ 0 ].m_position = Vec3f( 0.f, 1.f, 0.f );
	vertexes[ 0 ].m_textureCoords = Vec2f( 0.f, 0.f );

	vertexes[ 1 ].m_position = Vec3f( 0.f, 0.f, 0.f );
	vertexes[ 1 ].m_textureCoords = Vec2f( 0.f, 1.f );

	vertexes[ 2 ].m_position = Vec3f( 1.f, 0.f, 0.f );
	vertexes[ 2 ].m_textureCoords = Vec2f( 1.f, 1.f );

	vertexes[ 3 ].m_position = Vec3f( 1.f, 1.f, 0.f );
	vertexes[ 3 ].m_textureCoords = Vec2f( 1.f, 0.f );

	RenderVertexArrayWithShader( vertexes, 4, shaderProgramID, mode );
}


//---------------------------------------------------------------------------
void RenderTexturedQuadWithVertexArrayAndShader( const Rgba& colorTint, unsigned int shaderProgramID, VennEnum mode )
{
	Vertex3D vertexes[ 4 ];

	vertexes[ 0 ].m_position = Vec3f( 0.f, 1.f, 0.f );
	vertexes[ 0 ].m_textureCoords = Vec2f( 0.f, 0.f );
	vertexes[ 0 ].m_color = colorTint;

	vertexes[ 1 ].m_position = Vec3f( 0.f, 0.f, 0.f );
	vertexes[ 1 ].m_textureCoords = Vec2f( 0.f, 1.f );
	vertexes[ 1 ].m_color = colorTint;

	vertexes[ 2 ].m_position = Vec3f( 1.f, 0.f, 0.f );
	vertexes[ 2 ].m_textureCoords = Vec2f( 1.f, 1.f );
	vertexes[ 2 ].m_color = colorTint;

	vertexes[ 3 ].m_position = Vec3f( 1.f, 1.f, 0.f );
	vertexes[ 3 ].m_textureCoords = Vec2f( 1.f, 0.f );
	vertexes[ 3 ].m_color = colorTint;
...
//---------------------------------------------------------------------------
void RenderTexturedQuadFromSpriteSheetWithVertexArrayAndShader( const Vec2f& minTexCoords, const Vec2f& maxTexCoords, unsigned int shaderProgramID, VennEnum mode )
{
	Vertex3D vertexes[ 4 ];

	vertexes[ 0 ].m_position = Vec3f( 0.f, 1.f, 0.f );
	vertexes[ 0 ].m_textureCoords = Vec2f( minTexCoords.x, minTexCoords.y );

	vertexes[ 1 ].m_position = Vec3f( 0.f, 0.f, 0.f );
	vertexes[ 1 ].m_textureCoords = Vec2f( minTexCoords.x, maxTexCoords.y );

	vertexes[ 2 ].m_position = Vec3f( 1.f, 0.f, 0.f );
	vertexes[ 2 ].m_textureCoords = Vec2f( maxTexCoords.x, maxTexCoords.y );

	vertexes[ 3 ].m_position = Vec3f( 1.f, 1.f, 0.f );
	vertexes[ 3 ].m_textureCoords = Vec2f( maxTexCoords.x, minTexCoords.y );
...
//---------------------------------------------------------------------------
void RenderTexturedQuadFromSpriteSheetWithVertexArrayAndShader( const Rgba& colorTint, const Vec2f& minTexCoords, const Vec2f& maxTexCoords, unsigned int shaderProgramID, VennEnum mode )
{
	Vertex3D vertexes[ 4 ];
