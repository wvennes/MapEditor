...
ShaderProgram::ShaderProgram()
	...
	, m_isOriginalProgramInstance( true )
{
...
//---------------------------------------------------------------------------
ShaderProgram::ShaderProgram( const ShaderProgram& otherProgram )
	: m_programID( otherProgram.m_programID )
	, m_vertexShader( otherProgram.m_vertexShader )
	, m_fragmentShader( otherProgram.m_fragmentShader )
	, m_isOriginalProgramInstance( false )
{
...
ShaderProgram::~ShaderProgram()
{
	if ( m_isOriginalProgramInstance ) g_theRenderer->VennDeleteProgram( m_programID );
}
