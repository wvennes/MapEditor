...
//---------------------------------------------------------------------------
void VennRenderer::VennClearStencil( int s )
{
	glClearStencil( s );
}
...
//---------------------------------------------------------------------------
void VennRenderer::VennStencilFunc( VennEnum func, int ref, unsigned int mask )
{
...
//---------------------------------------------------------------------------
void VennRenderer::VennStencilOp( VennEnum fail, VennEnum zfail, VennEnum zpass )
{
...
//---------------------------------------------------------------------------
void VennRenderer::VennColorMask( unsigned char red, unsigned char green, unsigned char blue, unsigned char alpha )
{
