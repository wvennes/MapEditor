...
public:
	...
	static const Matrix4	GetTranslationMatrix( const Vec2f& translation );
	...
	void					ApplyThisMatrixToVector( Vec2f& value ) const;
...
//---------------------------------------------------------------------------
STATIC inline const Matrix4 Matrix4::GetTranslationMatrix( const Vec2f& translation )
{
	Matrix4 result;
